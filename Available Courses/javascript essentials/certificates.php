...
// Calculate Quiz Progress (25% of total - only for JavaScript Essentials)
...
$certificate_id = 'JOMCODING-' . strtoupper(substr(md5($user_id . 'javascript_essentials'), 0, 8));
                ...
                <div class="certificate-wrapper">
                    <div class="certificate-document" id="certificate">
                        ...
                        <div class="cert-body">
                            ...
                            <div class="cert-course-title">JavaScript Essentials</div>
