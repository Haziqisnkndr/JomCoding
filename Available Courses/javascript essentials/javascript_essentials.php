<?php
// javascript_essentials.php - JavaScript Essentials Course Dashboard with Progress Tracking
session_start();
...
$course_id = 4; // JavaScript Essentials
...
// Calculate progress based on videos watched (25% per video, 3 videos = 75% max)
$total_videos = 3;
$watched_count = count($watched_videos);
$progress_percentage = $watched_count * 25; // 25% per video
...
// Sample video data for JavaScript Essentials
$course_videos = [
    [
        'id' => 2,
        'title' => 'JavaScript Programming - Full Course',
        'description' => 'Complete JavaScript tutorial covering fundamentals, ES6+, DOM, and modern features by freeCodeCamp.',
        'duration' => '3:26:43',
        'level' => 'Beginner',
        'thumbnail' => '⚡',
        'url' => 'https://www.youtube.com/embed/PkZNo7MFNFg'  // freeCodeCamp - JavaScript Full Course
    ],
    [
        'id' => 3,
        'title' => 'JavaScript Tutorial for Beginners',
        'description' => 'Learn JavaScript from scratch: variables, functions, DOM manipulation, and projects by Mosh.',
        'duration' => '48:17',
        'level' => 'Beginner',
        'thumbnail' => '🚀',
        'url' => 'https://www.youtube.com/embed/W6NZfCO5SIk'  // Mosh - JavaScript Tutorial
    ],
    [
        'id' => 4,
        'title' => 'Modern JavaScript ES6+',
        'description' => 'Master modern JavaScript features: arrow functions, async/await, modules, and more.',
        'duration' => '50:05',
        'level' => 'Intermediate',
        'thumbnail' => '💡',
        'url' => 'https://www.youtube.com/embed/NCwa_xi0Uuc'  // freeCodeCamp - ES6+ JavaScript
    ],
...
<head>
    ...
    <title>JavaScript Essentials | JomCoding</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="javascript_essentials.php" class="nav-item active">
                <span>Lessons</span>
            </a>
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            <div class="page-title">
                <h1>JavaScript Essentials Course</h1>
            </div>
        ...
        <div class="content-area">
            ...
            <div class="progress-dashboard">
                <div class="progress-header">
                    ...
                    <p>Track your journey through JavaScript Essentials</p>
                </div>
                ...
                <p style="margin-top: 12px; font-size: 14px; opacity: 0.9;">
                    ...
                    <?php else: ?>
                        🎯 Click on any video below to start learning! Each video = 25% progress
                    <?php endif; ?>
                </p>
            </div>
            ...
            <div class="section-header">
                <h3>🎥 Video Lessons</h3>
                <p>Watch comprehensive video tutorials to master JavaScript programming</p>
            </div>
            ...
            <div class="lessons-grid">
                ...
                foreach($lessons as $index => $lesson): 
                    ...
                    $lesson_images = [
                        '../../assets/Bab 10.jpeg',  // Lesson 1 - Introduction to Programming (Capital B)
                       ...
                       <h3 class="lesson-slide-title">
                        ...
                        <div class="lesson-slide-meta">
                            <div class="lesson-slide-status">
                                <span> Learn it with Logical Ways!
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function showProgressNotification(percentage) {
            ...
            notification.style.cssText = `
                ...
                animation: slideInRight 0.3s ease;
            `;
            notification.innerHTML = `🎉 +25% Progress! You're now at ${percentage}%`;
            document.body.appendChild(notification);
        ...
        const lessonSlides = {
            1: ['/jomcoding/slides/slide8.pdf'],  // Introduction to Programming
    ...
    const slideFiles = ['/jomcoding/slides/slide8.pdf'];
