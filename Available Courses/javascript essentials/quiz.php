<?php
// quiz.php - JavaScript Essentials Quiz Page
session_start();
...
// Get all quizzes for JavaScript Essentials
...
// Get user's quiz statistics (only for JavaScript Essentials course)
$stats_query = "SELECT 
...
<head>
    ...
    <title>JavaScript Essentials Quiz | JomCoding</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="javascript_essentials.php" class="nav-item">
                <span>Lessons</span>
            </a>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="quiz-header">
                ...
                <p>Challenge yourself with <?php echo $total_questions; ?> questions covering all JavaScript Essentials topics</p>
