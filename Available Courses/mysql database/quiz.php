<?php
// quiz.php - MySQL Database Quiz Page
session_start();
...
// Get all quizzes for MySQL Database
...
// Get user's quiz statistics (only for MySQL Database course)
$stats_query = "SELECT 
...
<head>
    ...
    <title>MySQL Database Quiz | JomCoding</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="mysql_database.php" class="nav-item">
                <span>Lessons</span>
            </a>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="quiz-header">
                ...
                <p>Challenge yourself with <?php echo $total_questions; ?> questions covering all MySQL Database topics</p>
