<?php
// quiz_results.php - Quiz Results Page for MySQL Database
session_start();
...
if($percentage >= 90) {
    $grade = 'A+';
    $grade_color = '#10b981';
    $message = 'Outstanding! You have excellent knowledge of MySQL Database!';
    ...
    <div class="content-wrapper">
        <div class="results-container">
            <div class="results-header">
                ...
                <p>Here are your results for MySQL Database Quiz</p>
            </div>
