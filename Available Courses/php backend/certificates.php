...
// Calculate Quiz Progress (25% of total - only for PHP Backend)
...
$certificate_id = 'JOMCODING-' . strtoupper(substr(md5($user_id . 'php_backend'), 0, 8));
                ...
                <div class="certificate-wrapper">
                    <div class="certificate-document" id="certificate">
                        ...
                        <div class="cert-body">
                            ...
                            <div class="cert-course-title">PHP Backend</div>
