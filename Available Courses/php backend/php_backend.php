<?php
// programming_basics.php - PHP Backend Course Dashboard with Progress Tracking
session_start();
...
// Sample video data for PHP Backend
$course_videos = [
    [
        'id' => 2,
        'title' => 'Learn PHP The Right Way - Full Course',
        'description' => 'Comprehensive PHP 8 tutorial series by Program With Gio covering modern PHP best practices.',
        'duration' => '7:01',
        'level' => 'Beginner',
        'thumbnail' => '⚙️',
        'url' => 'https://www.youtube.com/embed/sVbEyFZKgqk'  // Program With Gio - Learn PHP The Right Way
    ],
    [
        'id' => 3,
        'title' => 'PHP & MySQL Full Course',
        'description' => 'Build dynamic websites with PHP and MySQL database integration by freeCodeCamp.',
        'duration' => '2:33:45',
        'level' => 'Intermediate',
        'thumbnail' => '🗄️',
        'url' => 'https://www.youtube.com/embed/1SnPKhCdlsU'  // freeCodeCamp - PHP & MySQL
    ],
    [
        'id' => 4,
        'title' => 'PHP Tutorial for Beginners',
        'description' => 'Step-by-step PHP course covering variables, loops, functions, and forms by The Net Ninja.',
        'duration' => '7:04',
        'level' => 'Beginner',
        'thumbnail' => '🔐',
        'url' => 'https://www.youtube.com/embed/pWG7ajC_OVo'  // The Net Ninja - PHP Tutorial
    ],
...
<head>
    ...
    <title>PHP Backend | JomCoding</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="php_backend.php" class="nav-item active">
                <span>Lessons</span>
            </a>
        ...
        <div class="content-area">
            ...
            <div class="progress-dashboard">
                <div class="progress-header">
                    ...
                    <p>Track your journey through PHP Backend</p>
                </div>
            ...
            <div class="lessons-grid">
                ...
                foreach($lessons as $index => $lesson): 
                    ...
                    $lesson_images = [
                        '../../assets/Bab 7.jpg',  // Lesson 1 - Introduction to Programming (Capital B)
                       ...
                       <h3 class="lesson-slide-title">
                        ...
                        <div class="lesson-slide-meta">
                            <div class="lesson-slide-status">
                                <span>Simple Text, always the same
                            </div>
                        </div>
                    </div>
                </div>
    ...
    const slideFiles = ['/jomcoding/slides/slide7.pdf'];
