<?php
// quiz.php - PHP Backend Quiz Page
session_start();
...
// Get all quizzes for PHP Backend
...
// Get user's quiz statistics (only for PHP Backend course)
$stats_query = "SELECT 
...
<head>
    ...
    <title>PHP Backend Quiz | JomCoding</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="php_backend.php" class="nav-item">
                <span>Lessons</span>
            </a>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="quiz-header">
                ...
                <p>Challenge yourself with <?php echo $total_questions; ?> questions covering all PHP Backend topics</p>
