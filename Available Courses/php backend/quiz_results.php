<?php
// quiz_results.php - Quiz Results Page for PHP Backend
session_start();
...
if($percentage >= 90) {
    $grade = 'A+';
    $grade_color = '#10b981';
    $message = 'Outstanding! You have excellent knowledge of PHP Backend!';
} elseif($percentage >= 80) {
    $grade = 'A';
    $grade_color = '#10b981';
    $message = 'Great job! You have a strong understanding of PHP concepts!';
} elseif($percentage >= 70) {
    $grade = 'B';
    $grade_color = '#3b82f6';
    $message = 'Good work! Keep practicing to master PHP development!';
    ...
    <div class="content-wrapper">
        <div class="results-container">
            <div class="results-header">
                ...
                <p>Here are your results for PHP Backend Quiz</p>
            </div>
