<?php
// programming_basics.php - Programming Basics Course Dashboard with Progress Tracking
session_start();
...
// Get user's video progress (15% per video)
...
// Calculate progress based on videos watched (15% per video, 5 videos = 75% max)
$total_videos = 5;
$watched_count = count($watched_videos);
$progress_percentage = ($watched_count / $total_videos) * 75; // Cap at 100%
...
// Sample video data for Programming Basics
$course_videos = [
    [
        'id' => 1,
        'title' => 'Introduction to Programming - Getting Started',
        'description' => 'Learn the fundamentals of programming and understand what makes a programmer successful.',
        'duration' => '01:59:09',
        'level' => 'Beginner',
        'thumbnail' => '🎓',
    ...
    [
        ...
        'description' => 'Deep dive into variables, data types, and how computers store information.',
        'duration' => '01:04',
        'level' => 'Beginner',
        'thumbnail' => '📦',
        'url' => 'https://www.youtube.com/embed/9rhT3P1MDHk'
    ],
    [
        'id' => 3,
    ...
    [
        'id' => 4,
        'title' => 'Functions and Methods in Programming',
        'description' => 'Learn how to write efficient, reusable code with functions and parameters.',
        'duration' => '06.45',
        'level' => 'Intermediate',
        'thumbnail' => '⚙️',
        'url' => 'https://www.youtube.com/embed/eHu2PxP0Caw'
    ],
    [
        'id' => 5,
        'title' => 'Advanced Programming Concepts',
        'description' => 'Explore advanced topics like algorithms, data structures, and optimization.',
        'duration' => '05:22:08',
        'level' => 'Advanced',
        'thumbnail' => '🚀',
...
<head>
    ...
    <title>Programming Basics | JomCoding</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="programming_basics.php" class="nav-item active">
                <span>Lessons</span>
            </a>
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            <div class="page-title">
                <h1>Basic Learning of Programming</h1>
            </div>
        ...
        <div class="content-area">
            ...
            <div class="progress-dashboard">
                <div class="progress-header">
                    ...
                    <p>Track your journey through Programming Basics</p>
                </div>
                ...
                <p style="margin-top: 12px; font-size: 14px; opacity: 0.9;">
                    ...
                    <?php else: ?>
                        🎯 Click on any video below to start learning! Each video = 15% progress
                    <?php endif; ?>
                </p>
            </div>
            ...
            <div class="section-header">
                ...
                <p>Complete all lessons to master programming basics</p>
            </div>
            ...
            <div class="lessons-grid">
                ...
                foreach($lessons as $index => $lesson): 
                    ...
                    $lesson_images = [
                        '../../assets/Bab 1.jpg',  // Lesson 1 - Introduction to Programming (Capital B)
                        '../../assets/bab 2.jpg',  // Lesson 2 - Variables and Data Types (lowercase b)
                        '../../assets/bab 3.jpg'   // Lesson 3 - Operators and Expressions (lowercase b)
                    ];
                    $lesson_image = $lesson_images[$index];
                ?>
                <div class="lesson-slide-card <?php echo $is_completed ? 'completed' : ''; ?>" 
                     onclick="openLessonSlides(<?php echo $index; ?>, '<?php echo htmlspecialchars($lesson['lesson_title'], ENT_QUOTES); ?>')">
                    ...
                    <div class="lesson-slide-content">
                        ...
                        <h3 class="lesson-slide-title"><?php echo htmlspecialchars($lesson['lesson_title']); ?></h3>
    ...
    <script>
        ...
        const lessonSlides = {
            0: ['/jomcoding/slides/slide1.pdf'],  // Lesson 1: Introduction to Programming
            1: ['/jomcoding/slides/slide2.pdf'],  // Lesson 2: Variables and Data Types
            2: ['/jomcoding/slides/slide3.pdf']   // Lesson 3: Operators and Expressions
        };

        function openLessonSlides(lessonId, lessonTitle) {
            console.log('Opening slides for lesson:', lessonId, lessonTitle); // Debug log
            currentLessonId = lessonId;
            currentSlideIndex = 0;
            
            // Check if lesson has slides
            if(!lessonSlides[lessonId]) {
                console.error('No slides found for lesson:', lessonId); // Debug log
                showNoSlidesMessage(lessonTitle);
                return;
            }
            
            console.log('Slides found:', lessonSlides[lessonId]); // Debug log
            
            // Update total slides count for this lesson
            totalSlidesCount = lessonSlides[lessonId].length;
