<?php
// quiz.php - Web Development Quiz Page
session_start();
...
// Get all quizzes for Web Development
...
// Get user's quiz statistics (only for Web Development course)
$stats_query = "SELECT 
...
<head>
    ...
    <title>Web Development Quiz | JomCoding</title>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="quiz-header">
                ...
                <p>Challenge yourself with <?php echo $total_questions; ?> questions covering all Web Development topics</p>
