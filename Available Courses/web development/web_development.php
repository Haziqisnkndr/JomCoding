<?php
// programming_basics.php - Web Development Course Dashboard with Progress Tracking
session_start();
...
$progress_percentage = min($watched_count * 15, 100); // Cap at 100%
...
// Sample video data for Web Development
$course_videos = [
    [
        'id' => 1,
        'title' => 'HTML Basics - Structure Your First Webpage',
        'description' => 'Learn HTML fundamentals and create your first web page from scratch.',
        'duration' => '2:02:32',
        'level' => 'Beginner',
        'thumbnail' => '🌐',
    ...
    [
        ...
        'description' => 'Master CSS to make your websites beautiful and responsive.',
        'duration' => '6:18:38',
        'level' => 'Beginner',
        'thumbnail' => '🎨',
    ...
    [
        'id' => 3,
        'title' => 'JavaScript Basics - Make Your Site Interactive',
        'description' => 'Add interactivity to your websites with JavaScript essentials.',
        'duration' => '48:17',
        'level' => 'Intermediate',
        'thumbnail' => '⚡',
    ...
    [
        ...
        'description' => 'Learn to create websites that work perfectly on all devices.',
        'duration' => '2:02.22',
        'level' => 'Intermediate',
        'thumbnail' => '📱',
        'url' => 'https://www.youtube.com/embed/p0bGHP-PXD4'
    ],
    [
        'id' => 5,
        'title' => 'Web Development Project - Build a Complete Website',
        'description' => 'Put everything together and build your first complete website project.',
        'duration' => '2:17:18',
        'level' => 'Advanced',
        'thumbnail' => '🚀',
...
<head>
    ...
    <title>Web Development | JomCoding</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="web_development.php" class="nav-item active">
                <span>Lessons</span>
            </a>
        ...
        <div class="content-area">
            ...
            <div class="lessons-grid">
                ...
                foreach($lessons as $index => $lesson): 
                    ...
                    $lesson_images = [
                        '../../assets/Bab 4.jpg',  // Lesson 1 - Introduction to Programming (Capital B)
    ...
    <script>
        ...
        const lessonSlides = {
            1: ['/jomcoding/slides/slide4.pdf'],  // Introduction to Programming
    ...
    const slideFiles = ['/jomcoding/slides/slide4.pdf', '/jomcoding/slides/slide5.pdf', '/jomcoding/slides/slide6.pdf'];
